...
class ParallelXdmfDataWriter2D {
public:
    ParallelXdmfDataWriter2D(const std::string &fname);
    ~ParallelXdmfDataWriter2D();

    template <typename T>
    void writeDataField(MultiBlock2D &multiBlock, const std::string &field_name);
