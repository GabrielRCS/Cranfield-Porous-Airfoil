...
# Solver type: "fluent", "openfoam", "cfx", "starccm", "su2", "palabos", "custom"
SOLVER="palabos"
...
# Modules to load (space-separated) (none if custom code)
...
setup_solver() {
    ...
    case $solver in
        ...
        palabos)
            SOLVER_EXECUTABLE="airfoil"  # Replace with actual Palabos executable
            SOLVER_ARGS=""         # Replace with actual arguments
            INPUT_FILE="*.xml"    # Replace with actual input file
            ;;
